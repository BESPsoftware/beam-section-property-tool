...
Endpoint dragging is not currently implemented; use the table for precise
endpoint edits.
...
Shear center and warping constant are not displayed as calculated Canvas
outputs. The FE mesh is a lightweight visualization mesh, not a solver-quality
mesh.
